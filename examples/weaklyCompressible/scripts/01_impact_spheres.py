...
parser.add_argument('--L', '-L', type=float, default=4, help='Length of the domain')
...
simulationName = 'Sphere Impact'
exportName = '01_sphere_impact'
freeSurface = True
...
particleState.velocities[particleState.positions[:,0] < 0, 0] = 0.5
particleState.velocities[particleState.positions[:,0] > 0, 0] = -0.5
