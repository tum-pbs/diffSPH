...
parser.add_argument('--L', '-L', type=float, default=6, help='Length of the domain')
...
simulationName = 'Rotating Square Patch'
exportName = '03_rotatingSquarePatch'
...
ffluid_sdf = lambda x: sampleDomainSDF(x, domain, invert = True)
...
particleState.velocities[:,0] = omega * particleState.positions[:,1]
particleState.velocities[:,1] = -omega * particleState.positions[:,0]
