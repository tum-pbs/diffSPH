...
parser.add_argument('--k', '-k', type=int, default=2, help = 'wavenumber')
parser.add_argument('--u_mag', '-u', type=float, default=1, help = 'Velocity Magnitude')
...
particleState.positions = shuffleParticles(particleState, config, 256)
k_ = k
