...
simulationName = 'Periodic Random Flow'
...
exportName = f'06_periodicRandomFlow_{octaves}_{lacunarity}_{persistence}_{baseFrequency}_{tileable}_{kind}_{seed}_{"with" if obstacle else "without"}'
