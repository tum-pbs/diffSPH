...
simulationName = 'Moving Obstacle'
exportName = f'12_movingObstacle'
...
regions.append(buildRegion(sdf = obstacle_sdf, config = config, type = 'boundary', kind = 'driven'))
...
rigidBodies[0].angularVelocity = np.pi/4
