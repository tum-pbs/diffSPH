...
from diffSPH.util import DomainDescription
try:
    from torchCompactRadius.util import DomainDescription, PointCloud
except ImportError:
    from diffSPH.dataLoaderUtils.fallback import DomainDescription, PointCloud
...
import torch
from diffSPH.dataLoaderUtils.ops import scatter_sum
